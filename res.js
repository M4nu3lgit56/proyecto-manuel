window.addEventListener('load', function () {
    const info = ['\"Aunque al principio no tenia mucha confianza, realmente me sorprendí cuando me vi al espejo. 100% recomendado.\"', '\"El mejor corte que he tenido en mucho tiempo. El barbero entendió perfectamente lo que quería y el resultado fue impecable. ¡Totalmente recomendable!\"', '\"Excelente atención y profesionalismo. Me hicieron un corte personalizado que superó mis expectativas. El ambiente es relajante y acogedor. Definitivamente regresaré.\"', '\"Llevaba tiempo buscando una barbería de confianza y finalmente la encontré. El servicio es increíble, el corte perfecto y la experiencia completa es de primera calidad.\"', '\"Me encanta venir a HECTOR BARBER. El barbero es muy profesional y siempre salgo con un corte perfecto. ¡El ambiente también es genial y relajante!\"', '\"Quede muy satisfecho con mi corte y me sentí con mas confianza, lo recomiendo bastante.\"']
